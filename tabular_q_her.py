...
cur_state_replay_buffer = CircularBuffer(np.zeros((REPLAY_BUFFER_SIZE, *input_shape), dtype="int32")) # *goal, *obs
next_state_replay_buffer = CircularBuffer(np.zeros((REPLAY_BUFFER_SIZE, *input_shape), dtype="int32")) # *goal, *obs
