...
Algorithms include: Tabular Q-Learning (w/ optional linear interpolation), Deep Q-Learning (DQN); TODO: Advantage Actor-Critic (A2C), Proximal Policy Optimization (PPO), Soft Actor-Critic (SAC). TODO: Hindsight Experience Replay, Rainbow DQN.
